        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('reservasi.update', $reservasi) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select name="id_ruangan" id="id_ruangan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                ...
                                @foreach($ruangan as $room)
                                    <option value="{{ $room->id_ruangan }}" {{ old('id_ruangan', $reservasi->id_ruangan) == $room->id_ruangan ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_kegiatan" id="tanggal_kegiatan" 
                                   ...
                                   value="{{ old('tanggal_kegiatan', $reservasi->tanggal_kegiatan->format('Y-m-d')) }}" 
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="time" name="waktu_mulai" id="waktu_mulai" 
                                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                                       value="{{ old('waktu_mulai', $reservasi->waktu_mulai->format('H:i')) }}" required>
                            </div>
                            <div>
                                <label for="waktu_selesai" class="block text-gray-700 text-sm font-bold mb-2">Waktu Selesai:</label>
                                <input type="time" name="waktu_selesai" id="waktu_selesai" 
                                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                                       value="{{ old('waktu_selesai', $reservasi->waktu_selesai->format('H:i')) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="tujuan_kegiatan" id="tujuan_kegiatan" rows="3" 
                                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                                      required>{{ old('tujuan_kegiatan', $reservasi->tujuan_kegiatan) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="jumlah_peserta" id="jumlah_peserta" 
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                                   value="{{ old('jumlah_peserta', $reservasi->jumlah_peserta) }}" required min="1">
                        </div>
